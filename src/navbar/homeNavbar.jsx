  ...
  return (
    <div>
      ...
      >
        ...
        <div style={{ display: isSmallScreen ? "none" : "flex", alignItems: "center", gap: "10px" }}>
          <ThemeToggler />
          {!isAuth && (
            <>
              <Link
        ...
        <div style={{ display: isSmallScreen ? "flex" : "none", alignItems: "center" }}>
          ...
          >
            ...
            {!isAuth && (
              <>
                <MenuItem onClick={handleMenuClose}>
                  <Link to="/login" style={{ textDecoration: "none", color: textColor }}>
                    Login
                  </Link>
                </MenuItem>
                <MenuItem onClick={handleMenuClose}>
                  <Link to="/signup" style={{ textDecoration: "none", color: textColor }}>
                    Signup
                  </Link>
                </MenuItem>
              </>
